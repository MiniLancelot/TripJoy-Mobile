...
// import { addPlan, getPlanById } from "@/services/plan/plan";
// import { router, SearchParams, Stack, useLocalSearchParams } from "expo-router";
...
//         setData({
//           title: plan.title,
//           startDate: plan.estimatedEndDate.split("T")[0],
//           endDate: plan.estimatedStartDate.split("T")[0],
//           estimatedBudget: plan.estimatedBudget,
//           provinceStart: plan.provinceStart,
//           provinceEnd: plan.provinceEnd,
//           method: plan.method,
